...
public class LevelGroundGenerator : MonoBehaviour
{
    ...
    int[] floorTilesToSpawn = new int[6] { 0, 0, 0, 0, 1, 0};
    int[] ceilingTilesToSpawn = new int[6] { 0, 0, 0, 0, 1, 0 };
    int[] leftWallTilesToSpawn = new int[6] { 0, 0, 0, 0, 1, 0 };
    int[] rightWallTilesToSpawn = new int[6] { 0, 0, 0, 0, 1, 0 };
    ...
    public static LevelGroundGenerator instance;
    ...
    void Update()
    {
        ...
        if (mainCamera.WorldToViewportPoint(spawnedFloorTiles[0].endPoint.position).z < -5)
        {
            ...
            // floor tiles
                tileTmp = Instantiate(tiles[floorTilesToSpawn[counter]], floorStartPoint.position, Quaternion.identity) as PlatformTile;
            ...
            // ceiling tiles
                tileTmp = Instantiate(tiles[ceilingTilesToSpawn[counter]], ceilingStartPoint.position, Quaternion.identity) as PlatformTile;
            ...
            // left wall tiles
                tileTmp = Instantiate(tiles[leftWallTilesToSpawn[counter]], leftWallStartPoint.position, Quaternion.identity) as PlatformTile;
            ...
            // right wall tiles
                ...
                tileTmp = Instantiate(tiles[rightWallTilesToSpawn[counter]], rightWallStartPoint.position, Quaternion.identity) as PlatformTile;
